...
constexpr unsigned int FCAP_DONT_SAVE = 0x80000000; // Don't save this
...
constexpr int FCAP_ONLYDIRECT_USE = 0x00000100;	   // LRC - can't use this entity through a wall
...
constexpr int CLASS_HUMAN_MILITARY_FRIENDLY = 14;  // Opposing Force friendlies
constexpr int CLASS_ALIEN_RACE_X = 15;
constexpr int CLASS_FACTION_A = 16;	   // LRC - simple new classes, for use with Behaves As
constexpr int CLASS_FACTION_B = 17;	   // LRC
constexpr int CLASS_FACTION_C = 18;	   // LRC
constexpr int CLASS_CTFITEM = 30;
